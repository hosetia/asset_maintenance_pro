...
TAXONOMY = [
    ...
    ("SYM-007","Symptom","Water Leak"),
    ("SYM-008","Symptom","Fire Alarm Triggered"),
    ("SYM-009","Symptom","Unit Not Starting"),
    ("SYM-010","Symptom","Low Pressure"),
    # Causes
    ("CAU-001","Cause","Compressor Failed"),
    ("CAU-002","Cause","Thermostat Fault"),
    ("CAU-003","Cause","Gas Leak"),
    ("CAU-004","Cause","Power Fluctuation"),
    ("CAU-005","Cause","Capacitor Failed"),
    ("CAU-006","Cause","Dirty Coils"),
...
def execute():
    for code, ttype, desc in TAXONOMY:
